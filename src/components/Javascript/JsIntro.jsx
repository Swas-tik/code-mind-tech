  ...
  return (
    <>
      <section className="w-full p-4">
        <h1 className="text-6xl">JavaScript Introduction</h1>
        <hr className="mt-4"/>
        <main className="mt-4 p-4 text-lg">
          ...
          <section className="mt-4 p-4 bg-slate-100 border-2 rounded-xl border-slate-300 leading-10">
            ...
            <p><strong>HTML</strong> to define the content of web pages</p>
            <p><strong>CSS</strong> to specify the layout of web pages</p>
            <p><strong>JavaScript</strong> to program the behavior of web pages</p>
          </section>
        </main>
      </section>
    </>
